Number Play
=============
"Number Play" is an educational simulation in HTML5, by <a href="https://phet.colorado.edu/" target="_blank">PhET Interactive Simulations</a>
...
<a href="https://phet.colorado.edu/sims/html/number-play/latest/number-play_en.html" target="_blank">Click here to run "Number Play".</a>

<a href="https://phet.colorado.edu/sims/html/number-play/latest/number-play_en.html" target="_blank">
<img src="https://raw.githubusercontent.com/phetsims/number-play/master/assets/number-play-screenshot.png" alt="Screenshot" style="width: 400px;"/>
</a>
...
(5) Open in the browser: `http://localhost/number-play/number-play_en.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
...
(3) Open in the browser: `http://localhost/number-play/build/adapted-from-phet/number-play_en_adapted-from-phet.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
